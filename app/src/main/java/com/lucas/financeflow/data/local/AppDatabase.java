...
@Database(entities = {Lancamento.class, com.lucas.financeflow.data.model.Cadastro.class, com.lucas.financeflow.data.model.WearReceipt.class}, version = 5, exportSchema = false)
