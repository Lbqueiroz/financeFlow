...
@Database(entities = {Lancamento.class, com.lucas.financeflow.data.model.Cadastro.class, com.lucas.financeflow.data.model.WearReceipt.class, com.lucas.financeflow.data.model.PlanItem.class, com.lucas.financeflow.data.model.InstallmentPlan.class}, version = 7, exportSchema = false)
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static final Migration MIGRATION_6_7 = new Migration(6, 7) {
        @Override public void migrate(SupportSQLiteDatabase db) {
            db.execSQL("CREATE TABLE IF NOT EXISTS installment_plans (id TEXT NOT NULL PRIMARY KEY, name TEXT NOT NULL, account TEXT NOT NULL, category TEXT NOT NULL, firstDate TEXT NOT NULL, totalCents INTEGER NOT NULL, count INTEGER NOT NULL)");
            db.execSQL("ALTER TABLE lancamentos ADD COLUMN installmentPlanId TEXT");
            db.execSQL("ALTER TABLE lancamentos ADD COLUMN installmentNumber INTEGER NOT NULL DEFAULT 0");
        }
    };
}
