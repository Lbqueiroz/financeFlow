...
public class DatabaseTest {
    ...
    @Test public void migratesVersionTwoAndRepairsMisplacedFields() {
        ...
        db = Room.databaseBuilder(context, AppDatabase.class, "migration-test").addMigrations(AppDatabase.MIGRATION_2_3, AppDatabase.MIGRATION_3_4, AppDatabase.MIGRATION_4_5, AppDatabase.MIGRATION_5_6, AppDatabase.MIGRATION_6_7).allowMainThreadQueries().build();
    ...
    @Test public void migratesVersionOneWithoutDeletingHistory() {
        ...
        db = Room.databaseBuilder(context, AppDatabase.class, "migration-v1-test").addMigrations(AppDatabase.MIGRATION_1_2, AppDatabase.MIGRATION_2_3, AppDatabase.MIGRATION_3_4, AppDatabase.MIGRATION_4_5, AppDatabase.MIGRATION_5_6, AppDatabase.MIGRATION_6_7).allowMainThreadQueries().build();
